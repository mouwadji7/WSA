...
function PageForm({ onSubmit }) {
  ...
  return (
    <main class="container mt-5 pt-5">
      ...
      <p>
        Remplissez le formulaire numero 1 ci-dessous pour obtenir un devis
        ...
        <div class="col">
          ...
          <div class="row mt-5">
            <div class="col">
              ...
              <ul class="no-bullets">
                <li>
                  <i class="bi bi-check-circle"></i> Service professionnel et
                  fiable
                </li>
                <li>
                  <i class="bi bi-check-circle"></i> Équipe qualifiée et
                  expérimentée
                </li>
                <li>
                  <i class="bi bi-check-circle"></i> Personnalisation des
                  services pour répondre à vos besoins
                </li>
                <li>
                  <i class="bi bi-check-circle"></i> Équipement moderne et
                  technologie de pointe
                </li>
                <li>
                  <i class="bi bi-check-circle"></i> Transparence des coûts
                </li>
              </ul>
            </div>
          </div>
