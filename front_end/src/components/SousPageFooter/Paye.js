      ...
      <div className="container mt-5 payment-container">
        ...
        <form onSubmit={handlePaymentSubmit}>
          <div className="mb-3">
            <h5 className="text-muted mb-2">
              Saisissez le numéro de référence de votre soumission :
            </h5>
            <input
              type="text"
              id="referenceNumber"
          ...
          <div className="mb-3">
            <h5 className="text-muted mb-2">
              Saisissez les détails de votre carte bancaire :
            </h5>
            <input
              type="text"
              id="cardNumber"
        ...
        <div className="mt-4">
          <p className="text-muted">
            Ne vous inquiétez pas, vos informations de paiement sont sécurisées.
            Nous sommes là pour vous aider à rendre votre expérience de
            déménagement aussi fluide que possible !
          </p>
        </div>
      </div>
    </main>
